...
from app.forms import RegistrationForm, LoginForm, UpdateProfileForm  # Подключаем новую форму
...
@login_required
def account():
    form = UpdateProfileForm()  # Используем форму для обновления профиля
